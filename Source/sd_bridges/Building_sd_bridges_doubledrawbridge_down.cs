...
public class Building_sd_bridges_doubledrawbridge_down : Building_sd_bridges_doubledrawbridge
{
    public IntVec3 BridgeCell = new IntVec3(0, 0, 0);
    public IntVec3 BridgeCell2 = new IntVec3(0, 0, 0);
    ...
    public override IEnumerable<Gizmo> GetGizmos()
    {
        ...
        {
            defaultDesc = "sd_bridges.doubledrawbridge_up_Desc".Translate(),
            defaultLabel = "sd_bridges.doubledrawbridge_up_Lable".Translate(),
    ...
    public override void SpawnSetup(Map map, bool respawningAfterLoad)
    {
        ...
        if (terrainDef2 == TerrainDef.Named("Mud"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeMudDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("Marsh"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeMarshDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("WaterShallow"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeWaterShallowDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("WaterOceanShallow"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeWaterOceanShallowDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("WaterMovingShallow"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeWaterMovingShallowDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("WaterDeep"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeDeepWaterDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("WaterOceanDeep"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeWaterOceanDeepDef);
        }
        ...
        if (terrainDef2 == TerrainDef.Named("WaterMovingChestDeep"))
        {
            ...
            map.terrainGrid.SetTerrain(BridgeCell2, Util_sd_bridges.Sd_bridges_fakeWaterMovingChestDeepDef);
        }
    ...
    public override void Destroy(DestroyMode mode = DestroyMode.Vanish)
    {
        ...
        Map.terrainGrid.SetTerrain(BridgeCell2, TerrainDef.Named(TerrainTypeAtBridgeCellDefAsString));
        base.Destroy(mode);
    }

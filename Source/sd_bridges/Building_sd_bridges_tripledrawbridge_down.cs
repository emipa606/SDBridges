...
public class Building_sd_bridges_tripledrawbridge_down : Building_sd_bridges_basedrawbridge
{
    protected override void SpawnDrawbridge()
    {
        ...
        {
            var thing = ThingMaker.MakeThing(sd_bridges_tripledrawbridge_up, Stuff);
        ...
        {
            Messages.Message("sd_bridges_tripledrawbridge_not_both_water".Translate(), MessageTypeDefOf.CautionInput);

...
public class PlaceWorker_quaddrawbridge : PlaceWorker
{
        ...
        Thing thingToIgnore = null, Thing thing = null)
    {
        ...
        if (Util_sd_bridges.IsAquaticTerrain(map, loc) &&
            ...
            Util_sd_bridges.IsAquaticTerrain(map, loc + new IntVec3(-1, 0, 0).RotatedBy(rot)) &&
            Util_sd_bridges.IsAquaticTerrain(map, loc + new IntVec3(-1, 0, 1).RotatedBy(rot)) &&
            Util_sd_bridges.IsAquaticTerrain(map, loc + new IntVec3(2, 0, 0).RotatedBy(rot)) &&
            Util_sd_bridges.IsAquaticTerrain(map, loc + new IntVec3(2, 0, 1).RotatedBy(rot)))
        {
